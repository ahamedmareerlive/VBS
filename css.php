    <script src="<?php echo bloginfo('stylesheet_directory'); ?>/assets/js/redirect.js"></script>
    <!-- Favicon -->
    <link href="<?php echo get_stylesheet_directory_uri(); ?>/Template/img/favicon.png" rel="icon">
    ...
    <link href="<?php echo get_stylesheet_directory_uri(); ?>/assets/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css" rel="stylesheet" />
